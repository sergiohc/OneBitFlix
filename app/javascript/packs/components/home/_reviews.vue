    ...
    <v-flex md4 xs10 mb-3 mt-2 offset-xs1>
      <v-card color="grey darken-3">
        <v-card-text>
          ...
          <v-container fluid>
            <v-layout row wrap>
              <heart-rating v-model="rating" :item-size="20" :show-rating="false" active-color="#f44336" inactive-color="#fff" border-color="#424242"></heart-rating>

              <v-flex md12>
                <v-text-field name="input-1" label="Descreva o que achou em pelo menos 50 caracteres..." textarea dark color="red" rows="2" v-model="description" required></v-text-field>
              </v-flex>
