...
# Movies sem série
movie2 = Movie.create(title: "Dominando o Docker", description: "O
...
"vscode-serie-cover.png", last_watched_episode_id: 1, category:
outros)
movie5 = Movie.create(title: "Dominando o Visual Studio Code - Parte
...
episode_number: 1)
movie6 = Movie.create(title: "Dominando o Visual Studio Code - Parte
