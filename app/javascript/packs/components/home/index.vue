<template>
  <div>
    ...
    <MovieList v-for='(category, index) in categories' :key='index' :name='category.attributes.name' :movies='[...category.attributes.movies.data, ...category.attributes.series.data]' />
  </div>
</template>
